    ...
    allPages: [
      {
        ...
        pageCoverThumbnail: BLOG.HOME_BANNER_IMAGE || 'https://cdn.jsdmirror.com/gh/88lin/picx-images-hosting@master/bg-image.webp',
        date: {
...
function getSiteInfo({ collection, block, NOTION_CONFIG }) {
  ...
  const defaultPageCover = NOTION_CONFIG?.HOME_BANNER_IMAGE || 'https://cdn.jsdmirror.com/gh/88lin/picx-images-hosting@master/bg-image.webp'
