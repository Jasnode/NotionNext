...
module.exports = {
  ...
  SEO_BAIDU_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-JLZEmj9ZAo', // Remove the value or replace it with your own google site verification code

  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || null, // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合

  UMAMI_HOST: process.env.NEXT_PUBLIC_UMAMI_HOST || '', // umami的服务地址：https://cloud.umami.is/script.js
