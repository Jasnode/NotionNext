...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 86400, // 更新缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '茉灵智库,Spring,记录生活,分享资源,资源,文献,考研,技术教程,Windows,chatgpt,软件', // 网站关键词 英文逗号隔开
  ...
  CUSTOM_EXTERNAL_CSS: ['https://cdn.jsdmirror.com/gh/88lin/picx-images-hosting@master/custom.css'], 
