...
- 配置名复制：复制 `HEXO_COLOR_PRIMARY` 这类键名。
- 配置值复制：复制当前输入框里的值。
...
HEXO_COLOR_TEXT=#374151
HEXO_COLOR_BG=#f5f5f5
HEXO_COLOR_PRIMARY_DARK=#928CEE
HEXO_COLOR_TEXT_DARK=#d1d5db
HEXO_COLOR_BG_DARK=#000000
```
