export default function HelloCover({ play, title }) {
  return (
    <>
      <svg
        ...
        role='img'
        aria-label={title || 'hero recommend cover'}>
        <defs>
        ...
        <g clipPath='url(#heo-hello-inline-clip)'>
          <g transform='matrix(1.6770009994506836,0,0,1.6770009994506836,-168.750244140625,-165.7444610595703)'>
            <g transform='matrix(1,0,0,1,252,245.91799926757812)'>
              <path
                className={`heo-hello-stroke ${play ? 'is-playing' : ''}`}
                pathLength='1000'
      ...
      <style>{`
        ...
        .heo-hello-stroke.is-playing {
          animation: heo-hello-draw 2290ms
            cubic-bezier(0.302, 0.14, 0.665, 1) 210ms both;
        }

        @keyframes heo-hello-draw {
          0% {
            stroke-dashoffset: 1000;
            stroke-opacity: 0;
            stroke-width: 9;
