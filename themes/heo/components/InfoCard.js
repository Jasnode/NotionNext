    ...
    <Card className='wow fadeInUp card-gradient text-white flex flex-col w-72 overflow-hidden rounded-2xl relative'>
      ...
      <div className='flex justify-center relative'>
        ...
        <div
          className={`${
            useBlurAvatar
              ? '-mt-8 -mr-6 hover:opacity-0 hover:scale-150 blur'
              : 'cursor-pointer'
          } absolute right-0 justify-center items-center flex dark:text-gray-100 transform transition-all duration-200`}>
          <LazyImage
            src={siteInfo?.icon}
      ...
      <div className='flex flex-wrap gap-3 justify-between'>
        <div className='flex flex-wrap gap-3 dark:hover:text-white'>
          {/* 社交按钮 */}
          {url1 && (
