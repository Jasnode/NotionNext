...
export default function PostRecommend({ recommendPosts, siteInfo }) {
  ...
  return (
    <section className='heo-post-footer__recommend hidden md:block'>
      <div className='overflow-hidden rounded-[1.9rem] border border-slate-200/80 bg-white/96 p-4 shadow-[0_14px_36px_rgba(15,23,42,0.045)] dark:border-slate-700/50 dark:bg-slate-800/40 sm:p-5'>
            ...
            return (
              <SmartLink
                ...
                <div className='space-y-2.5 p-3.5 sm:p-4'>
                  <div className='line-clamp-2 text-[1.02rem] font-semibold leading-7 text-slate-800 transition-colors duration-300 group-hover:text-slate-950 dark:text-slate-100 dark:group-hover:text-[#ffc848] sm:text-lg'>
                    {post.title}
                  </div>
