  ...
  return (
    ...
    >
      ...
      <div className='hidden lg:flex justify-between items-end mt-10 px-px pb-px font-medium text-black duration-500 dark:text-gray-300 pt-3 space-x-2 overflow-x-auto'>
        ...
        >
          <div className='hover:border-indigo-600 dark:hover:border-indigo-500 relative w-24 h-10 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border dark:border-gray-600 rounded-full cursor-pointer group'>
        ...
        <div className='flex items-center space-x-2'>
          ...
          {/* 跳转页码 */}
          <div className='bg-white hover:bg-gray-100 dark:hover:bg-indigo-500  dark:bg-[#1e1e1e]  h-10 border dark:border-gray-600 flex justify-center items-center rounded-full group hover:border-indigo-600 transition-all duration-200'>
            <input
              value={value}
            ...
            <div
              onClick={jumpToPage}
              className='cursor-pointer hover:bg-indigo-600 dark:hover:bg-indigo-500 hover:text-white px-4 py-2 group-hover:px-2 group-hover:mx-1 rounded-full'
            >
      ...
      <div className='lg:hidden w-full flex flex-row'>
        ...
        <SmartLink
          ...
          rel='prev'
          aria-label={locale?.PAGINATION?.PREV || 'Previous page'}
          className={`${showPrev ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border rounded-full cursor-pointer`}
        >
          {locale.PAGINATION.PREV}
        </SmartLink>
        ...
        <SmartLink
          ...
          rel='next'
          aria-label={locale?.PAGINATION?.NEXT || 'Next page'}
          className={`${showNext ? 'block' : 'hidden'} dark:text-white relative w-full flex-1 h-14 flex items-center transition-all duration-200 justify-center py-2 px-2 bg-white dark:bg-[#1e1e1e] border rounded-full cursor-pointer`}
        >
          {locale.PAGINATION.NEXT}
        </SmartLink>
      </div>
  ...
  return (
    <SmartLink
      ...
      className={
        ...
        ' hover:border-indigo-600 dark:hover:bg-indigo-500 dark:border-gray-600 w-10 h-10 border rounded-full drop-shadow-sm duration-200 transition-colors inline-flex items-center justify-center'
      }
    >
      {page}
    </SmartLink>
